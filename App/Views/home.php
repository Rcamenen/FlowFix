    ...
    <div class="main__content">
        ...
        <div class="wrapper">
            ...
            <section class="main__section main__section--first section container">
                ...
                <div class="section__top">
                    <h1 class="title-xl">Résolvez les <span class="text--highlight">irritants</span> qui freinent votre équipe</h1>
                </div>
        ...
        <div class="wrapper--alt">
            ...
            <section id=comment-ca-marche class="main__section section container">
                ...
                <div class="section__top">
                    ...
                    <h2 class="section__title title-xl">Simple. Collectif. Efficace.</h2>
        ...
        <div class="wrapper">
            ...
            <section class="main__section section container">
                ...
                <div class="section__top">
                    ...
                    <h2 class="section__title title-xl">Tout ce qu'il faut, rien de superflu</h2>
                ...
                <ul class="list">
                    ...
                    <li>
                        <h3 class="title-sm">Pensé mobile d'abord</h3>
                        <p class="text--xs">Interface responsive optimisée en priorité pour mobile. Navigation fluide sans rechargement, menus accessibles en permanence, design sobre et lisible.</p>
                    </li>
                </ul>
        ...
        <div class="wrapper--alt">
            ...
            <section id="pret-a-commencer" class="main__section section container">
                ...
                <div class="section__top">
                    <p class="section-label txt-center">Prêt à commencer ?</p>
                    <h2 class=" txt-center section__title title-xl">Donnez la parole à votre équipe</h2>
